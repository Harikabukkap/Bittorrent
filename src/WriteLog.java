...
public class WriteLog
{
  ...
  {        String filename = "peer_" + peer1+"/log_peer_"+peer1+".log";
           ...
           try
           {
               ...
               FileWriter fw = new FileWriter(filename,true); //the true will append the new data
               BufferedWriter bw = new BufferedWriter(fw);
               String str = getDate()+": Peer "+peer1+" initiated a connection to Peer "+peer2+".";
               bw.write(str);//appends the string to the file
               bw.newLine();
               bw.close();
            }
  ...
  public void Have(String peer1, String peer2, int index)
  {
		...
		CreateLog(peer1);
            ...
            try
           {
               FileWriter fw = new FileWriter(filename,true); //the true will append the new data
               BufferedWriter bw = new BufferedWriter(fw);
               String str = getDate()+peer2+" sending have message to Peer "+peer1+" for piece "+index;
               bw.write(str);//appends the string to the file
               bw.newLine();
               bw.close();
            }
	  ...
	  String filename = "peer_" + peer1+"/log_peer_"+peer1+".log";
		...
		CreateLog(peer1);
            ...
            try
           {
               FileWriter fw = new FileWriter(filename,true); //the true will append the new data
               BufferedWriter bw = new BufferedWriter(fw);
               String str = getDate()+ peer2+"sending interested message to "+peer1;
               bw.write(str);//appends the string to the file
               bw.newLine();
               bw.close();
            }
	  ...
	  String filename = "peer_" + peer1+"/log_peer_"+peer1+".log";
		...
		CreateLog(peer1);
            ...
            try
           {
               FileWriter fw = new FileWriter(filename,true); //the true will append the new data
               BufferedWriter bw = new BufferedWriter(fw);
               String str = getDate()+peer2+" sending not interested message to "+peer1;
               bw.write(str);//appends the string to the file
               bw.newLine();
               bw.close();
            }
	  ...
	  String filename = "peer_" + peer1+"/log_peer_"+peer1+".log";
		...
		CreateLog(peer1);
            ...
            try
           {
               FileWriter fw = new FileWriter(filename,true); //the true will append the new data
               BufferedWriter bw = new BufferedWriter(fw);
               String str = getDate()+": Peer "+peer1+" has downloaded the piece "+index+" from Peer "+peer2;
               bw.write(str);//appends the string to the file
               bw.newLine();
               bw.close();
            }
  ...
  public void SentHandshake(int peer1)
  {
		...
		CreateLog(Integer.toString(peer1));
            ...
            try
           {
               FileWriter fw = new FileWriter(filename,true); //the true will append the new data
               BufferedWriter bw = new BufferedWriter(fw);
               String str = getDate()+"Handshake message has been sent by Peer "+peer1;
               bw.write(str);//appends the string to the file
               bw.newLine();
               bw.close();
            }
